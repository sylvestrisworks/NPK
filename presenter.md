# Talarmanus — NPK för måltidsservice ledningsgrupp

Detta är manuset du läser ur när du scrollar live. Tidsbudget ~25 minuter.
Varje akt har: **(a)** *vad som visas på skärmen* och **(b)** *vad du säger utöver det*.

> **Tips:** öppna sajten i webbläsare, tryck `F11` för fullscreen. Ha denna fil öppen på laptop bredvid projektor.
...
## Akt 2 · Den första sprickan (3 min)
...
## Akt 3 · Hormuz (5 min) — **kärnan i dragningen**

**Skärm:** Karta över Persiska viken. Rutter ritas i grönt, blir röda när stängningen visas. Tre räknare animeras.

**Du säger på varje step:**
- *Step 1:* "Hormuzsundet är 33 kilometer brett som smalast. Som jämförelse är Öresund 4 km. Men där Öresund är en hobbyfarled är Hormuz världens viktigaste energipulsåra."
- *Step 2:* "Qatar är världens näst största LNG-exportör. **93 % av deras LNG passerar Hormuz.** För UAE är siffran 96 %. Genom samma vatten skeppas också färdig konstgödsel direkt till risbältet i Asien."
- *Step 3 (här ändras kartan):* "Den 4 mars i år stängde Iran sundet. Vi är åttio dagar in. Det fanns en kortlivad återöppning 21 april som kollapsade inom ett dygn. Tankertrafiken är ned ungefär 70 %."
- *Step 4 (emphasis, räknarna animeras):* "Tjugo procent av globalt LNG. Tjugofem procent av världens olja. IEA kallar det den största försörjningsstörningen i den globala oljemarknadens historia."
- *Step 5:* "Asien drabbas först. Indien, Bangladesh, Pakistan importerar direkt från Persiska viken för att säkra sina risskördar. De kommer börja buda mot Europa om varenda tillgänglig last."

**Pausa här i ~10 sekunder.** Låt kartan med röda rutter stå. Detta är dragningens visuella ankare.

**Frågor som kan komma:** 
- "Kan inte oljan komma runt på annat sätt?" → "Pipeline-kapaciteten genom Saudiarabien och UAE förbi sundet är ~4 mbd. Sundet flödar normalt ~20 mbd. Bypass täcker högst 20 % av volymen."
- "Vad gör amerikansk gas?" → "USA exporterar redan på maxkapacitet via Sabine Pass m.fl. Asien betalar nu mer för den, så Europa möter samma marknadspris."

---

## Akt 4 · Den fördröjda chocken (5 min)

**Skärm:** EU gaslager-graf. 2025-linjen som referens, 2026-linjen som ligger lägre, "vi är här"-marker på maj.
...
## Akt 7 · Nyanser & frågor (~5 min Q&A)

**Skärm:** Expanderbara nyans-block.

**Vanliga frågor du kan förbereda:**

| Fråga | Svar |
|---|---|
| "Kan inte regeringen subventionera bort?" | "På kort sikt: ja, till viss del. Men det är fortfarande globala priser vi möter. Subventioner förskjuter kostnaden, eliminerar den inte." |
| "Vad gör de andra upphandlarna?" | "Stockholm, Göteborg, Malmö har sannolikt redan börjat scenarioplanera. Vi behöver inte vara först men kan inte vara sist." |
...
- **Övning:** kör igenom en gång själv med stoppur. Sikta på 22–25 min för punkterna ovan, så har du 5 min buffert till Q&A.
- **Backup:** om projektorn strular, ha sajten öppen i två fönster (en på laptop, en på telefon) — exportera även en PDF via Chrome (`Print → Save as PDF`).
- **Efter mötet:** mejla länken till sajten + denna fil till deltagarna. De som vill djupdyka kan klicka in på `energi_till_livsmedelspriser.html` och `datapunkter_energi_gödsel_livsmedel.html` direkt från Akt 5.
